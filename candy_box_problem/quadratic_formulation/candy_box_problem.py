...
# variavel de decisão: 1, se o bombom i for para a crianca j
#                      0, caso contrário
...
def restricao_de_cobertura(modelo, i):
    return modelo.x[i, 1] + modelo.x[i, 2] == 1


# cria uma restrição de cobertura para cada bombom
modelo.restricao_de_cobertura = \
    poe.Constraint(modelo.B, rule=restricao_de_cobertura)
